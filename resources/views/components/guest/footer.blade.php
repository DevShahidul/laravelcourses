<footer class="w-full bg-dark text-white pt-[94px] relative self-end">
    <div class="container max-w-[440px] sm:max-w-7xl w-full px-4 sm:px-6 lg:px-8 mx-auto">
        <img src="{{ asset('assets/images/footer-cure.png') }}" alt="Stylish Design" class="w-auto h-auto object-contain absolute bottom-0 right-0 pointer-events-none z-10">
